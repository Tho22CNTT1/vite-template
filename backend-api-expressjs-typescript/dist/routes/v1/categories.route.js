...
router.post('/', authenticateToken, authorize([Role.Admin, Role.Manager]), categoriesController.create);
router.get('/', authenticateToken, authorize([Role.Admin, Role.Staff]), categoriesController.findAll);
router.post('/', authenticateToken, authorize([Role.Admin]), categoriesController.create);
