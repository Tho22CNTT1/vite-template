...
router.get('/', routeStaffMidleware2, validateSchemaYup(staffValidation.findAll), staffController.findAll);
// POST - tạo staff mới
router.post('/', validateSchemaYup(staffValidation.createStaff), staffController.create);
// GET - lấy staff theo ID
router.get('/:id', authenticateToken, validateSchemaYup(staffValidation.findById), staffController.findOne);
// PUT - cập nhật staff theo ID
router.put('/:id', validateSchemaYup(staffValidation.updateById), staffController.update);
// DELETE - xóa staff theo ID
router.delete('/:id', validateSchemaYup(staffValidation.deleteById), staffController.deleteStaff);
